...
void AppDelegate::applicationDidEnterBackground()
{
    ...
    CGameData::Inst()->setEnterBackTime(TimeTransform::currentTime());
}
...
void AppDelegate::applicationWillEnterForeground()
{
    ...
    CGameData::Inst()->setComeBackTime(TimeTransform::currentTime() - CGameData::Inst()->getEnterBackTime());
